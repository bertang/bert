...
type IBaseRepo interface {
	...
	//@preloads 预加载字段
	//@return 列表， 总数， 错误
	List(cond interface{}, list interface{}, helper page.Helper, order string, preloads ...interface{}) (int64, error)
}
...
//List 查询列表
func (b *BaseRepository) List(cond interface{}, list interface{}, helper page.Helper, order string, preloads ...interface{}) (int64, error) {
	var count int64
	var err error
